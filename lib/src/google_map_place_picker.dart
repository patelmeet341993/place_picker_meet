...
import 'package:place_picker_meet/src/components/animated_pin.dart';
import 'package:place_picker_meet/src/components/floating_card.dart';
...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  final bool floatButtonVisible;
  final bool addressDialogVisible;
  ...
  _searchByCameraLocation(PlaceProvider provider) async {
    ...
    provider.latLng = LatLng(provider.cameraPosition!.target.latitude, provider.cameraPosition!.target.longitude);
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        ...
        _buildPin(),
        Visibility(visible: addressDialogVisible, child: _buildFloatingCard()),
        _buildMapIcons(context),
        Visibility(visible: floatButtonVisible, child: _buildFloatingButton(context))
      ],
    );
  }
